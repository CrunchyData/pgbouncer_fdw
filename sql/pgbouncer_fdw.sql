CREATE VIEW @extschema@.clients AS
...
CREATE VIEW @extschema@.config AS
    SELECT * FROM dblink('pgbouncer', 'show config') AS x 
    (   key text
        , value text
        , changeable boolean);

CREATE VIEW @extschema@.databases AS
...
CREATE VIEW @extschema@.servers AS
...
CREATE VIEW @extschema@.sockets AS
...
CREATE VIEW @extschema@.stats AS
...
CREATE VIEW @extschema@.users AS
